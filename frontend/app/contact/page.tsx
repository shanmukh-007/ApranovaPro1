              ...
              <CardContent className="pt-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">support@apranova.com</p>
                    <p className="text-sm text-muted-foreground">admissions@apranova.com</p>
                  </div>
                </div>
              </CardContent>
            </Card>
