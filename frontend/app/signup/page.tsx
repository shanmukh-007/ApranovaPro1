      ...
      <main className="min-h-svh flex items-center justify-center p-4 bg-gradient-to-br from-slate-900 to-slate-800">
        <div className="text-center space-y-6">
          <div className="relative">
            <div className="animate-spin rounded-full h-16 w-16 border-4 border-slate-700 border-t-emerald-500 mx-auto"></div>
            <div className="absolute inset-0 rounded-full bg-emerald-500/20 animate-pulse"></div>
          </div>
          <div className="space-y-2">
            <p className="text-slate-200 text-lg font-medium">Creating your account...</p>
